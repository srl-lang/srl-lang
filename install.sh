#!/usr/bin/env bash
# SRL Toolchain v0.3.0 Automated Installer for Linux & macOS
set -e

echo "========================================================"
echo "  SRL (Serial Run Language) v0.3.0 POSIX Installer"
echo "========================================================"
...
echo "========================================================"
echo "  SRL v0.3.0 Installed Successfully to $INSTALL_DIR"
echo "========================================================"
